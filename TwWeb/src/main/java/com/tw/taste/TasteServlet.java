...
//if("red".equals(color)) {
//color = "<span style='color:red;'><b>빨강</span>";
//}else if ("blue".equals(color)) {
//color = "<span style='color:blue;'><b>파랑</span>";
//}else if ("yellow".equals(color)) {
//color = "<span style='color:yellow;'><b>노랑</span>";
//}else if ("green".equals(color)) {
//color= "<span style='color:green;'><b>초록</span>";
//}
